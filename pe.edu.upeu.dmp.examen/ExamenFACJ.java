...
public class ExamenFACJ{

    static Scanner lt=new Scanner(System.in);
    public static void impuestocars_FACJ() {
        //Declarar variables
    ...
    public static void ejercicio_X_FACJ() {
      int alturadeX=0;
      do {
  ...
  for (int fil = 1; fil <= alturadeX; fil++){
   ...
   public static void númerosp_FACJ() {        
    int numero;
    int resultado;
    int suma=0;
    ...
    public static void númerosperfectosFACJ() {
      int i, j, suma;
    ...
    public static void DecimalaB_FACJ() {
...
public static void main(String[] args) {
  ...
  switch (pregunta) {
    case 1:
      impuestocars_FACJ(); break;
    case 2:
      ejercicio_X_FACJ(); break;
    case 3:
      númerosp_FACJ(); break;
    case 4:
     númerosp_FACJ()); break;
