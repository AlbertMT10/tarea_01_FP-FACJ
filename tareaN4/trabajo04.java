...
public class trabajo04 {
   ...
   public static void ejercicio43() {
    ...
    public static void ejercicio414() {
        int i, n;
    ...
    public static void ejercicio417() {
        double P, ahorros, i;
        int n;
        n=2022-1961;
        P=1500.0;
    ...
    public static void ejercicio422() {
        int i = 0;
    ...
    public static void ejercicio423() {
        for(int i = 320; i >= 160; i-=20) {
            System.out.println(i);
        }
    }
    public static void ejercicio426() {
